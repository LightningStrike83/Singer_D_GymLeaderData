let roxanneRS = document.querySelector ("#roxanne3");
let brawlyRS = document.querySelector ("#brawly3");
let wattsonRS = document.querySelector ("#wattson3");
let flanneryRS = document.querySelector ("#flannery3");
let normanRS = document.querySelector ("#norman3");
let winonaRS = document.querySelector ("#winona3");
let tatelizaRS = document.querySelector ("#tateliza3");
let wallaceRS = document.querySelector ("#wallace3");
let sidneyRS = document.querySelector ("#sidney3");
let phoebeRS = document.querySelector ("#phoebe3");
let glaciaRS = document.querySelector ("#glacia3");
let drakeRS = document.querySelector ("#drake3");
let stevenRS = document.querySelector ("#steven3");
...
roxanneRS.addEventListener('click', displayORASTrainers);
brawlyRS.addEventListener('click', displayORASTrainers);
wattsonRS.addEventListener('click', displayORASTrainers);
flanneryRS.addEventListener('click', displayORASTrainers);
normanRS.addEventListener('click', displayORASTrainers);
winonaRS.addEventListener('click', displayORASTrainers);
tatelizaRS.addEventListener('click', displayORASTrainers);
wallaceRS.addEventListener('click', displayORASTrainers);
sidneyRS.addEventListener('click', displayORASTrainers);
phoebeRS.addEventListener('click', displayORASTrainers);
glaciaRS.addEventListener('click', displayORASTrainers);
drakeRS.addEventListener('click', displayRSTrainers);
stevenRS.addEventListener('click', displayORASTrainers);