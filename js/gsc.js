...
let silverGGSC = document.querySelector ("#silver1_g");
let silverFGSC = document.querySelector ("#silver1_f");
let silverWGSC = document.querySelector ("#silver1_w");
...
silverGGSC.addEventListener('click', displayGSCTrainers);
silverFGSC.addEventListener('click', displayGSCTrainers);
silverWGSC.addEventListener('click', displayGSCTrainers);
