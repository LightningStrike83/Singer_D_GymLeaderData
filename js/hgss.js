...
let silverGHGSS = document.querySelector ("#silver2_g");
let silverFHGSS = document.querySelector ("#silver2_f");
let silverWHGSS = document.querySelector ("#silver2_w");
...
silverGHGSS.addEventListener('click', displayHGSSTrainers);
silverFHGSS.addEventListener('click', displayHGSSTrainers);
silverWHGSS.addEventListener('click', displayHGSSTrainers);
